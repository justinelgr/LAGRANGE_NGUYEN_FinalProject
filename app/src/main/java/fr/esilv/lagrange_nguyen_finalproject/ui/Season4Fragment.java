...
public class Season4Fragment extends Fragment {
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_season4, container, false);
        Button btn_trailer = (Button) root.findViewById(R.id.button_s4);
        btn_trailer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), SeasonsTrailers.class);
                String youtube_id = "wO3dP5jrJ8g";
