...
public class Season6Fragment extends Fragment {
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_season6, container, false);
        Button btn_trailer = (Button) root.findViewById(R.id.button_s6);
